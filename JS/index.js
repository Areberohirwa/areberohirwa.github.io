            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav mx-auto linking2 border-bottom border-3 border-danger p-2 rounded fixed-top mt-1 z-3 d-flex justify-content-around align-items-center flex-row flex-wrap">
                    <li class="nav-item me-1 mb-2 mb-lg-0">
                        <a class="text-decoration-none btn btn-outline-danger fw-bold" aria-current="page" href="#">Home</a>
                    </li>
                    <li class="nav-item me-1 mb-2 mb-lg-0">
                        <a class="text-decoration-none btn btn-outline-warning fw-bold" aria-current="page" href="./pages/about.html">About Me</a>
                    </li>
                    <li class="nav-item me-1 mb-2 mb-lg-0">
                        <a class="text-decoration-none btn btn-outline-warning fw-bold" aria-current="page" href="./pages/skill.html">Skills</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="text-decoration-none btn btn-outline-warning dropdown-toggle fw-bold" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            Projects
                        </a>
                        <ul class="dropdown-menu bg-warning">
                            <li><a class="dropdown-item rounded" href="#">Kijk_shop</a></li>
                            <li><a class="dropdown-item rounded" href="#">DashBoard</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item rounded" href="./pages/project.html">See All Projetcs</a></li>
                        </ul>
                    </li>
                </ul>
